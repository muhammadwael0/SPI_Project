...
set_property MARK_DEBUG true [get_ports MOSI]
set_property MARK_DEBUG true [get_ports MISO]
set_property MARK_DEBUG true [get_ports SS_n]
set_property MARK_DEBUG true [get_ports clk]
set_property MARK_DEBUG true [get_ports rst_n]
